...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pears.PearChatBlindPeering',
        icon: `${packagerConfig.icon}.png`,
        metainfo: 'build/metainfo.xml',
        entrypoint: 'build/entrypoint.sh',
        comment: 'A peer-to-peer chat example with blind peering, built with Pear and Electron',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'A peer-to-peer chat example with blind peering, built with Pear and Electron',
        description:
          'A peer-to-peer chat example demonstrating blind peering with pear-runtime embedded into an Electron desktop app.',
