...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pears.PearLiveCam',
        icon: `${packagerConfig.icon}.png`,
        metainfo: 'build/metainfo.xml',
        entrypoint: 'build/entrypoint.sh',
        comment: 'A peer-to-peer live camera streaming example built with Pear and Electron',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'A peer-to-peer live camera streaming example built with Pear and Electron',
        description:
          'A peer-to-peer live camera streaming example demonstrating Hyperblobs and hypercore-blob-server with pear-runtime embedded into an Electron desktop app.',
