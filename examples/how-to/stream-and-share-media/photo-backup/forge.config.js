...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pears.PearPhotoBackup',
        icon: `${packagerConfig.icon}.png`,
        metainfo: 'build/metainfo.xml',
        entrypoint: 'build/entrypoint.sh',
        comment: 'A peer-to-peer photo backup example built with Pear and Electron',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'A peer-to-peer photo backup example built with Pear and Electron',
        description:
          'A peer-to-peer photo backup example demonstrating media decoding (bare-ffmpeg/bare-media) over Hyperblobs with pear-runtime embedded into an Electron desktop app.',
