...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pears.PearVideoStream',
        icon: `${packagerConfig.icon}.png`,
        metainfo: 'build/metainfo.xml',
        entrypoint: 'build/entrypoint.sh',
        comment: 'A peer-to-peer video streaming example built with Pear and Electron',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'A peer-to-peer video streaming example built with Pear and Electron',
        description:
          'A peer-to-peer video streaming example demonstrating stored video over hypercore-blob-server with pear-runtime embedded into an Electron desktop app.',
