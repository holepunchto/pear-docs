...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pears.PearFileSharing',
        icon: `${packagerConfig.icon}.png`,
        metainfo: 'build/metainfo.xml',
        entrypoint: 'build/entrypoint.sh',
        comment: 'A peer-to-peer file sharing example built with Pear and Electron',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'A peer-to-peer file sharing example built with Pear and Electron',
        description:
          'A peer-to-peer file sharing example demonstrating Hyperdrive over a shared room with pear-runtime embedded into an Electron desktop app.',
