...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pears.PearChatMultiRooms',
        icon: `${packagerConfig.icon}.png`,
        metainfo: 'build/metainfo.xml',
        entrypoint: 'build/entrypoint.sh',
        comment: 'A peer-to-peer chat example with multiple rooms, built with Pear and Electron',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'A peer-to-peer chat example with multiple rooms, built with Pear and Electron',
        description:
          'A peer-to-peer chat example demonstrating multiple rooms with pear-runtime embedded into an Electron desktop app.',
