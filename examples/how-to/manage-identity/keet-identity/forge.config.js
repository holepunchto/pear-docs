...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      platforms: ['linux'],
      config: {
        appId: 'com.pears.PearChatIdentity',
        icon: `${packagerConfig.icon}.png`,
        metainfo: 'build/metainfo.xml',
        entrypoint: 'build/entrypoint.sh',
        comment: 'A peer-to-peer chat example with Keet identity, built with Pear and Electron',
    ...
    },
    {
      ...
      config: {
        ...
        summary: 'A peer-to-peer chat example with Keet identity, built with Pear and Electron',
        description:
          'A peer-to-peer chat example demonstrating Keet identity keys with pear-runtime embedded into an Electron desktop app.',
