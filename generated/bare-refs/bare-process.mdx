...
<sub>[Source](https://github.com/holepunchto/bare-process/blob/v4.5.0/index.d.ts#L8)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-process/blob/v4.5.0/global.d.ts#L3)</sub>
