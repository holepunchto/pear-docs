...
<sub>[Source](https://github.com/holepunchto/bare-broadcast-channel/blob/v0.2.0/index.d.ts#L26)</sub>
...
- `opts` (`BroadcastChannelOptions`, optional)
...
<sub>[Source](https://github.com/holepunchto/bare-broadcast-channel/blob/v0.2.0/index.d.ts#L30)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-broadcast-channel/blob/v0.2.0/index.d.ts#L28)</sub>

Maximum number of ports that may connect to a single channel over its lifetime.

#### `connect(): Port<T>`

<sub>[Source](https://github.com/holepunchto/bare-broadcast-channel/blob/v0.2.0/index.d.ts#L22)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-broadcast-channel/blob/v0.2.0/index.d.ts#L19)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-broadcast-channel/blob/v0.2.0/index.d.ts#L20)</sub>
