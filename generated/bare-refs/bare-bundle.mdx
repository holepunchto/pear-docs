...
| --- | --- | --- | --- |
| `opts?` | [`BundleOptions`](#bundleoptions) | — | — |
...
| --- | --- | --- | --- |
| `root` | `string` \| `URL` | — | — |
| `opts?` | [`BundleMountOptions`](#bundlemountoptions) | — | — |
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `opts?` | [`BundleToBufferOptions`](#bundletobufferoptions) | — | — |
...
| `key` | `string` | — | — |
| `data` | `string` | — | — |
| `opts?` | [`BundleWriteOptions`](#bundlewriteoptions) | — | — |
...
| --- | --- | --- | --- |
| `data` | `string` \| `Buffer` | — | — |
| `opts?` | [`MemoryFileOptions`](#memoryfileoptions) | — | — |
