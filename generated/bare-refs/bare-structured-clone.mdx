...
#### `DataCloneError.DataCloneError.INVALID_ARRAY_LAYOUT(msg: string): DataCloneError`
...
#### `DataCloneError.DataCloneError.INVALID_PROPERTY_KEY(msg: string): DataCloneError`
...
#### `DataCloneError.DataCloneError.INVALID_TYPE(msg: string): DataCloneError`
...
#### `DataCloneError.DataCloneError.INVALID_VIEW(msg: string): DataCloneError`
