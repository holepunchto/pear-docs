...
- `opts` (`TransformOptions<CryptoHash>`, optional)
...
- `algorithm` (`HashAlgorithm` | `number`)
- `key` (`string` | `Buffer`)
- `opts` (`TransformOptions<CryptoHmac>`, optional)
...
- `key` (`string` | `Buffer`)
- `iv` (`string` | `Buffer`)
- `opts` (`TransformOptions<Cipheriv>`, optional)
...
- `outputEncoding` (`BufferEncoding`, optional)
...
- `opts` (`{ encoding?: BufferEncoding }`, optional)
...
- `data` (`string` | `Buffer`)
- `inputEncoding` (`BufferEncoding`, optional)
- `outputEncoding` (`BufferEncoding`, optional)
...
- `algorithm` (`HashAlgorithm` | `number`)
- `opts` (`TransformOptions<Hash>`, optional)
...
- `algorithm` (`HashAlgorithm` | `number`)
- `key` (`string` | `Buffer`)
- `opts` (`TransformOptions<Hmac>`, optional)
