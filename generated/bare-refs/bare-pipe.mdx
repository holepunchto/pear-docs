...
| --- | --- | --- | --- |
| `path` | `string` | — | — |
| `opts?` | [`PipeConnectOptions`](#pipeconnectoptions) | — | — |
| `onconnect?` | `() => void` | — | — |
...
| --- | --- | --- | --- |
| `path` | `string` | — | — |
| `opts?` | [`CreateConnectionOptions`](#createconnectionoptions) | — | — |
| `onconnect?` | `() => void` | — | — |
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `opts?` | [`PipeServerOptions`](#pipeserveroptions) | — | — |
| `onconnection?` | `() => void` | — | — |
...
| `handle?` | [`IPCAcceptable`](#ipcacceptable) | — | — |
...
| `path` | `string` | — | — |
| `backlog?` | `number` | — | — |
| `opts?` | [`PipeServerListenOptions`](#pipeserverlistenoptions) | — | — |
| `onlistening?` | `() => void` | — | — |
