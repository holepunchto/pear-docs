...
| --- | --- | --- | --- |
| `socket?` | `TCPSocket` | — | — |
| `opts?` | [`HTTPIncomingMessageOptions`](#httpincomingmessageoptions) | — | — |
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `opts?` | [`HTTPServerConnectionOptions`](#httpserverconnectionoptions) | — | — |
...
| `statusMessage?` | [`HTTPStatusMessage`](#httpstatusmessage) | — | — |
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `opts?` | [`HTTPClientRequestOptions`](#httpclientrequestoptions) | — | — |
| `onresponse?` | `() => void` | — | — |
...
| --- | --- | --- | --- |
| `socket` | `TCPSocket` | — | — |
| `opts?` | [`HTTPClientConnectionOptions`](#httpclientconnectionoptions) | — | — |
