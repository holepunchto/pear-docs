...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/index.d.ts#L42)</sub>
...
- `probeModule` (`(url: URL) => boolean | undefined`, optional)
- `resolveModule` (`(url: URL) => URL`, optional)
...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/index.d.ts#L36)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/index.d.ts#L91)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/lib/resolve/default.d.ts#L4)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/lib/resolve/bare.d.ts#L10)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/lib/resolve/node.d.ts#L9)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/lib/resolve/bare.d.ts#L4)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-module-traverse/blob/v2.4.0/lib/resolve/node.d.ts#L4)</sub>
