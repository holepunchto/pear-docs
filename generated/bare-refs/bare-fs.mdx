...
| `opts?` | [`WriteFileOptions`](#writefileoptions) | — | — |
...
| --- | --- | --- | --- |
| `filepath` | [`Path`](#path) | — | — |
| `opts?` | [`MkdirOptions`](#mkdiroptions) | — | — |
...
| --- | --- | --- | --- |
| `path` | [`Path`](#path) \| `null` | — | — |
| `opts?` | [`ReadStreamOptions`](#readstreamoptions) | — | — |
