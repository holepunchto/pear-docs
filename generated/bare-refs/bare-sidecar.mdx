...
<sub>[Source](https://github.com/holepunchto/bare-sidecar/blob/v0.5.2/index.d.ts#L17)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-sidecar/blob/v0.5.2/index.d.ts#L13)</sub>

The readable standard error stream of the underlying process.

#### `stdin: Pipe | null`

<sub>[Source](https://github.com/holepunchto/bare-sidecar/blob/v0.5.2/index.d.ts#L11)</sub>

The writable standard input stream of the underlying process.

#### `stdout: Pipe | null`

<sub>[Source](https://github.com/holepunchto/bare-sidecar/blob/v0.5.2/index.d.ts#L12)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-sidecar/blob/v0.5.2/index.d.ts#L4)</sub>
...
<sub>[Source](https://github.com/holepunchto/bare-sidecar/blob/v0.5.2/index.d.ts#L8)</sub>
