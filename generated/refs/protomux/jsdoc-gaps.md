...
`holepunchto/protomux` at **v3.11.0** · **94%** of published members fully documented (16/17) · 21 source member(s) not in the manifest (internal or unfiled) — not graded.

Coverage by dimension: **descriptions 94%** · **param types 100%** · **typed returns 94%** · **examples 100%**. (Prose is usually present; the gap is mostly types.)
