...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L437)
...
| --- | --- | --- | --- |
| `stream` | `object` | — |  |
| `options` | [`ProtomuxOptions`](#protomuxoptions) | `{}` | include |
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L488)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L502)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L531)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L546)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L518)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L579)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L590)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L603)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L561)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L622)

Add a new protocol channel.

| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `options` | [`CreateChannelOptions`](#createchanneloptions) | — | Channel creation options. |
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L444)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L452)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L114)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L78)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L96)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L292)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L270)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L282)
...
[API definition on GitHub](https://github.com/holepunchto/protomux/blob/v3.11.0/index.js#L320)
