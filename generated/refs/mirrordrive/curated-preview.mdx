...
[src](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L290)
...
| `ignore` | [`string\|Array<string>`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array) | — | Paths to exclude from the source listing. |
