...
- Returns: [`Promise<EntryWatcher>`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) — a watcher which listens to changes on the given key.
