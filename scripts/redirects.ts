...
export function buildRedirects(contentRoot = 'content'): Redirect[] {
  ...
  out.push({ from: withSlash('/how-to/blind-peering/keep-data-available-with-blind-peering'), to: withSlash('/p2p/how-to/blind-peering/keep-data-available-with-blind-peering') });
  ...
  out.push({ from: withSlash('/how-to/stream-and-share-media/create-a-full-peer-to-peer-filesystem-with-hyperdrive'), to: withSlash('/p2p/how-to/stream-and-share-media/create-a-full-peer-to-peer-filesystem-with-hyperdrive') });
  ...
  out.push({ from: withSlash('/how-to/stream-and-share-media/store-and-serve-large-media-with-hyperblobs'), to: withSlash('/p2p/how-to/stream-and-share-media/store-and-serve-large-media-with-hyperblobs') });
  ...
  out.push({ from: withSlash('/pear/how-to/connect-to-peers/host-multiple-rooms-in-one-chat-app'), to: withSlash('/p2p/how-to/connect-to-peers/host-multiple-rooms-in-one-chat-app') });
  out.push({ from: withSlash('/pear/how-to/manage-identity'), to: withSlash('/p2p/how-to/manage-identity') });
  out.push({ from: withSlash('/pear/how-to/manage-identity/add-keet-identity-to-a-chat-app'), to: withSlash('/p2p/how-to/manage-identity/add-keet-identity-to-a-chat-app') });
  out.push({ from: withSlash('/pear/how-to/stream-and-share-media'), to: withSlash('/p2p/how-to/stream-and-share-media') });
  out.push({ from: withSlash('/pear/how-to/stream-and-share-media/back-up-photos-in-a-peer-to-peer-app'), to: withSlash('/p2p/how-to/stream-and-share-media/back-up-photos-in-a-peer-to-peer-app') });
