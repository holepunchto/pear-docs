...
const FAMILIES: Record<FamilyKey, FamilyConfig> = {
  bare: {
    ...
    catalogMdx: 'content/bare/reference/modules/bare-modules.mdx',
    catalogRoute: '/bare/reference/modules/bare-modules',
    extraSeeAlso: '[Bare runtime API](/bare/reference/bare/runtime) — the runtime these modules extend.',
    outDir: 'generated/bare-refs',
    contentDir: 'content/bare/reference/bare/modules',
  ...
  pear: {
    ...
    catalogMdx: 'content/pear/reference/modules/pear-modules.mdx',
    catalogRoute: '/pear/reference/modules/pear-modules',
    extraSeeAlso: '[Pear API](/pear/reference/pear/api) — the `Pear` global these modules build on.',
    outDir: 'generated/pear-refs',
    contentDir: 'content/pear/reference/pear/modules',
