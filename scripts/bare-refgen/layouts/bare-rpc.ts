...
const layout: Layout = {
  ...
  params: {
    'RPC.constructor': {
      stream:
        'The duplex stream to frame RPC messages over, identifying each method by a unique command number — an IPC pipe, a TCP socket, or a [Bare Kit](/bare/reference/bare/bare-kit) worklet channel.',
      onrequest:
