...
A file system API that is similar to [hyperdrive.md](../building-blocks/hyperdrive.md "mention"). This tool comes in handy when you want to mirror files from your filesystem to a drive, and vice-versa.

{% embed url="https://github.com/holepunchto/localdrive" %}
...
| **`atomic`**      | Enable atomicity for file writing (tmp file and rename). | Boolean | `false`  |
