...
export function ViewOptions({
  ...
  /**
   * Source file URL on GitHub (works for static sites; no runtime `/page.mdx` fetch).
   */
  githubUrl: string;
}) {
  const items = useMemo(() => {
    const q = `Read the documentation source at ${githubUrl}, I want to ask questions about it.`;
