...
- <a href="https://keet.io" pear-data="pear://keet" style="display: inline-flex; align-items: center; gap: 0.5em;"><img src="./assets/keet.svg" alt="Keet logo" width="32" height="32" style="vertical-align: middle; box-shadow: none;">Keet</a>: A peer-to-peer chat and video-conferencing application with end-to-end encryption.

- <a href="https://pass.pears.com" pear-data="pear://pass" style="display: inline-flex; align-items: center; gap: 0.5em;"><img src="./assets/pearpass.svg" alt="PearPass logo" width="32" height="32" style="vertical-align: middle; box-shadow: none;">PearPass</a>: A secure peer-to-peer password manager.
