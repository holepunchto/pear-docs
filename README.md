...
| [bare-rpc](https://github.com/holepunchto/bare-rpc)                           | [librpc](https://github.com/holepunchto/librpc) ABI compatible RPC for Bare  | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [Hypertele](https://github.com/bitfinexcom/hypertele)   | A swiss-knife proxy powered by `hyperdht`                | ![Windows][1] ![MacOS][2] ![Linux][3]                          | <mark style="background-color:#80ff80;">**stable**</mark> |
