...
| [bare-addon-resolve](https://github.com/holepunchto/bare-addon-resolve)       | Low-level addon resolution algorithm for Bare                        | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-ansi-escapes](https://github.com/holepunchto/bare-ansi-escapes)         | Parse and produce ANSI escape sequences                              | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-async-hooks](https://github.com/holepunchto/bare-async-hooks)           | `async_hooks` shim for Bare                                          | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-boot](https://github.com/holepunchto/bare-boot)                         | Boot drives in Bare                                                  | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-bundle-compile](https://github.com/holepunchto/bare-bundle-compile)     | Compile a bundle of CommonJS modules to a single module              | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-bundle-evaluate](https://github.com/holepunchto/bare-bundle-evaluate)   | Evaluate a bundle of CommonJS modules across JavaScript runtimes     | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-bundle-id](https://github.com/holepunchto/bare-bundle-id)               | Construct a unique ID for a bundle                                   | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-cov](https://github.com/holepunchto/bare-cov)                           | Run tests with coverage                                              | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-debug-log](https://github.com/holepunchto/bare-debug-log)               | Simple debug log for JavaScript                                      | ![Windows][1] ![MacOS][2] ![Linux][3]                              |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-delta](https://github.com/holepunchto/bare-delta)                       | Binary patch handling for Bare                                       | ![Windows][1] ![MacOS][2] ![Linux][3]                              |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-diagnostics-channel](https://github.com/holepunchto/bare-diagnostics-channel) | Create and publish data to named channels for diagnostics purposes | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-ffmpeg](https://github.com/holepunchto/bare-ffmpeg)                     | Low-level FFmpeg bindings for Bare                                   | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-file-logger](https://github.com/holepunchto/bare-file-logger)           | File system logger for Bare                                          | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-form-data](https://github.com/holepunchto/bare-form-data)               | Form data support for Bare                                           | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-gif](https://github.com/holepunchto/bare-gif)                           | GIF support for Bare                                                 | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-heif](https://github.com/holepunchto/bare-heif)                         | HEIF support for Bare                                                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-image-resample](https://github.com/holepunchto/bare-image-resample)     | Image resampling support for Bare                                    | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-jpeg](https://github.com/holepunchto/bare-jpeg)                         | JPEG support for Bare                                                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-link](https://github.com/holepunchto/bare-link)                         | Native addon linker for Bare                                         | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-logger](https://github.com/holepunchto/bare-logger)                     | Low-level logger for Bare with system log integration                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-make](https://github.com/holepunchto/bare-make)                         | Opinionated build system generator based on CMake                    | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-media](https://github.com/holepunchto/bare-media)                       | A set of media apis for Bare                                         | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-module-lexer](https://github.com/holepunchto/bare-module-lexer)         | Heuristic lexer for detecting imports and exports in JavaScript modules | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-module-resolve](https://github.com/holepunchto/bare-module-resolve)     | Low-level module resolution algorithm for Bare                       | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-module-traverse](https://github.com/holepunchto/bare-module-traverse)   | Low-level module graph traversal for Bare                            | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-node](https://github.com/holepunchto/bare-node)                         | Compatibility modules for Node.js builtins in Bare                   | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-node-fetch](https://github.com/holepunchto/bare-node-fetch)             | Cross runtime fetch module                                           | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-pack](https://github.com/holepunchto/bare-pack)                         | Bundle packing for Bare                                              | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-pack-drive](https://github.com/holepunchto/bare-pack-drive)             | Pack drives to Bare bundles                                          | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-performance](https://github.com/holepunchto/bare-performance)           | Performance monitoring for Bare                                      | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-png](https://github.com/holepunchto/bare-png)                           | PNG support for Bare                                                 | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-prebuild](https://github.com/holepunchto/bare-prebuild)                 | Tool for recursively prebuilding installed native addons from source | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-queue-microtask](https://github.com/holepunchto/bare-queue-microtask)   | Microtask queuing for Bare                                           | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-run](https://github.com/holepunchto/bare-run)                           | Cross-platform script runner for Bare                                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-runtime](https://github.com/holepunchto/bare-runtime)                   | Prebuilt Bare binaries for macOS, iOS, Linux, Android, and Windows   | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-sdl](https://github.com/holepunchto/bare-sdl)                           | SDL bindings for Bare                                                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-string-decoder](https://github.com/holepunchto/bare-string-decoder)     | `string_decoder` shim for Bare                                       | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-tiff](https://github.com/holepunchto/bare-tiff)                         | TIFF support for Bare                                                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-union-bundle](https://github.com/holepunchto/bare-union-bundle)        | Uinion bundle                                                         | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-unpack](https://github.com/holepunchto/bare-unpack)                    | Bundle unpacking for Bare                                             | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-utils](https://github.com/holepunchto/bare-utils)                      | Node.js-compatible utility functions for Bare                         | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-v8-to-istanbul](https://github.com/holepunchto/bare-v8-to-istanbul)    | Convert from V8 coverage format to Istanbul's coverage format         | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-walk-handles](https://github.com/holepunchto/bare-walk-handles)         | Walk the event loop handles of the Bare process                      | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-webp](https://github.com/holepunchto/bare-webp)                         | WebP support for Bare                                                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
| [bare-which](https://github.com/holepunchto/bare-which)                       | Find a program in $PATH                                              | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
...
| [bare-xdiff](https://github.com/holepunchto/bare-xdiff)                       | Bare native addon for the xdiff diff/merge algorithms                | ![Windows][1] ![MacOS][2] ![Linux][3] ![Android][4] ![iOS][5]      |  <mark style="background-color:#80ff80;">**stable**</mark> |
