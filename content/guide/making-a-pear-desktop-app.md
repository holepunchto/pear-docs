---
title: "Making a Pear Desktop Application"
description: "Tutorial: build a peer-to-peer desktop chat app with Pear."
---
...
<Cards>
  <Card title="Build with Pear - Episode 01: Developing with Pear" href="https://www.youtube.com/watch?v=y2G97xz78gU" external />
</Cards>
...
![Layout of the app](/images/docs/chat-app-3.png)
...
> Note that the `pear` dependency is used, even though it was not installed. This is the [Pear API](../reference/api.md#globalpear), available to any Pear project.
...
![The first app, with the topic](/images/docs/chat-app-4a.png)

Paste the topic into the second app, then click on `Join`.

![Second app, using topic from the first](/images/docs/chat-app-4b.png)

Once connected, messages can be sent between each chat application.

![View from the first app](/images/docs/chat-app-5a.png)

![View from the second app](/images/docs/chat-app-5b.png)
