...
description: "Scaffold and configure a new Pear desktop app with pear init."
---
...
![Running pear run --dev .](/images/docs/chat-app-1.png)
...
![Automatic reload](/images/docs/chat-app-2.png)
