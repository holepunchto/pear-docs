---
title: "Creating a Pear Init Template"
description: "Define _template.json, prompts, and distributable pear init templates."
---
...
pear run --dev .
```
<img src="/images/docs/pear-init.png"/ >
<!-- ![Layout of the app](/images/docs/pear-init.png) -->
