...
## The `package.json` `pear` field. [#pear]
...
#### `pear.stage.defer <Array>` [#pear-stage-defer]
...
### `pear.routes <Object|String>` [#pear-routes]
...
### `pear.unrouted <Array>` [#pear-unrouted]
...
###  `pear.links <Object|Array>` [#pear-links]
...
#### `pear.stage.prefetch <Array>` [#pear-stage-prefetch]
