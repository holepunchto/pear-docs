...
[src](https://github.com/holepunchto/autobase/blob/v7.28.1/index.js#L2189)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.1/index.js#L914)

Triggered when the autobase view updates after `apply` has finished running.

#### `base.on('interrupt', (reason) => { ... })`

[src](https://github.com/holepunchto/autobase/blob/v7.28.1/index.js#L913)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.1/index.js#L1639)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.1/index.js#L1849)

Triggered when the autobase instance is an indexer.

#### `base.on('is-non-indexer', () => { ... })`

[src](https://github.com/holepunchto/autobase/blob/v7.28.1/index.js#L1860)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.1/index.js#L927)
