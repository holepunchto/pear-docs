...
- [Build a multiwriter app with Autobase](/how-to/store-and-replicate/build-a-multiwriter-app-with-autobase)—two-peer walkthrough covering `open`, `apply`, and granting write access.
...
- [Autobee](/reference/building-blocks/autobee)—the same linearization with the view fixed to a Hyperbee and the B-tree write path built in.
