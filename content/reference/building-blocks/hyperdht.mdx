...
- Parameters:
  ...
  - Any additional options are forwarded to [`dht-rpc`](https://github.com/holepunchto/dht-rpc).
...
HyperDHT inherits additional lower-level RPC APIs from [`dht-rpc`](https://github.com/holepunchto/dht-rpc). Reach for those when you need custom queries beyond the keyed connection and record helpers above.
