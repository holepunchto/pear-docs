...
| --- | --- | --- | --- |
| `seq` | `number` | — | [Hypercore](/reference/building-blocks/hypercore) index (block number) at which this entry was inserted. |
...
- [Autobee](/reference/building-blocks/autobee)—the multiwriter form of this B-tree, where many peers write into one derived view.
