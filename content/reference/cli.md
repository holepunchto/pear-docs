...
## `pear run [flags] <link|dir> [...app-args]` [#pear-run]
...
## `pear stage <channel|link> [dir]` [#pear-stage]
...
## `pear seed <channel|link> [dir]` [#pear-seed]
...
## `pear release <channel|link> [dir]` [#pear-release]
...
## `pear info [link|channel]` [#pear-info]
...
## `pear touch [flags] [channel]` [#pear-touch]
