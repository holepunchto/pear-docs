...
<<<<<<< feat/add-seo-tooling
An update occurs when a seeded application drive is written to - see [Deployment](/reference/deployment).
=======
An update occurs when a seeded application drive is written to - see [Deployment](/how-to/operate-an-app/deployment).
>>>>>>> preview
...
- [Deploy your application](/how-to/operate-an-app/deployment) — production build flow that pairs with this runtime.
