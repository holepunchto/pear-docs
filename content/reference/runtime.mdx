...
* Embedded [Bare](/reference/bare-modules) workers
...
- [Pear CLI](/reference/cli) — the command-line counterpart to embedding `pear-runtime` in an app.
- [Configuration](/reference/configuration) — `package.json` fields that govern stage, seed, and update behaviour.
- [Bare modules](/reference/bare-modules) — the runtime workers above are Bare workers.
