...
{/* Maintainer note: "Command source on GitHub" links are pinned to v3.1.0, the release this page documents. Re-pin them when a newer release ships. To find flag-level drift, diff the command definitions between tags:
...
<Callout type="info">
This page tracks **Pear 3.1.0**. Several commands were removed in v3—most notably `pear run`, which is replaced by embedding the **[Pear OTA](/reference/pear/runtime)** (`pear-runtime`) library. Removed commands are kept below with a badge and migration guidance.
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/touch.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/stage.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/provision.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/multisig.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/seed.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/changelog.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/info.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/dump.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/cores.js)
...
With [`--json`](#json-output), each core is emitted as a `"tag": "core"` object carrying `{ link, writable }`, and the closing `"tag": "final"` object carries `{ count, writable }`.

Distinct from [`pear gc cores`](#pear-gc), which *clears* corestore cores rather than listing them.

### `pear data [flags] [command]`

[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/data.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/sidecar.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/gc.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/versions.js)
...
[Command source on GitHub](https://github.com/holepunchto/pear/blob/v3.1.0/cmd/index.js)
