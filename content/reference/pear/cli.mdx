...
<mark style={{ backgroundColor: '#f0e57a', padding: '2px 8px', borderRadius: '4px', fontSize: '0.85em', fontWeight: 500 }}>removed</mark>
...
<mark style={{ backgroundColor: '#f0d264', padding: '2px 8px', borderRadius: '4px', fontSize: '0.85em', fontWeight: 500 }}>upcoming</mark>
