...
- [Integrate Pear OTA into an existing mobile app](/how-to/operate-an-app/integrate-pear-ota/mobile)—wire this module's updater and `minver` gate into a React Native or Expo app you already have.
