...
**DEPRECATED**—superseded by the [Pear OTA](/reference/pear/runtime) (`pear-runtime`) API (instantiate `Pear` and use its instance instead). Applies to all `Pear.app.*` properties below.
