...
In an applications entrypoint create an instance of [`Pear`](https://github.com/holepunchto/pear-runtime/blob/v1.1.4/index.js#L8):
...
To run a Bare worker, [`pear.run`](https://github.com/holepunchto/pear-runtime/blob/v1.1.4/index.js#L49) takes its entrypoint with any args: 
