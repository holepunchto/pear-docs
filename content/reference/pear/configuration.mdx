...
`pear run` is deprecated; the fields below relate to it. Use the [`pear-runtime`](/reference/pear/runtime) module instead.
...
- [Pear CLI](/reference/pear/cli)—the commands that read these fields (`pear stage`, `pear seed`, `pear release`).
