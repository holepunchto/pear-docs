...
For typed, schema-generated messaging over this channel instead of raw bytes, layer [`bare-rpc`](/reference/modules/bare-modules) on top—see Type a native RPC bridge.
