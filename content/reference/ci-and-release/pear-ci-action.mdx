...
The [`pear-ci` GitHub Action](https://github.com/holepunchto/actions/blob/main/pear-ci/action.yml) stages a directory from your repository into a Hyperdrive on every run, producing a stable `pear://` link your app can use as its [`upgrade`](/reference/pear/configuration) field. For the task-oriented setup, see [Publish with GitHub Actions](/how-to/operate-an-app/github-actions/publish-with-github-actions).
