...
The majority of capabilities are supplied via [Pear Modules](/#pear-modules).
...
Compat-mode opt-in. See [/how-to/operate-an-app/migration#compat-mode](/how-to/operate-an-app/migration#compat-mode)
...
The majority of capabilities are supplied via [Bare Modules](/#bare-modules).
