...
`pear run` is deprecated and will be removed and the global API with it. Use the [`pear-runtime`](https://github.com/holepunchto/pear-runtime) module instead.
...
<mark style={{ backgroundColor: '#f0e57a', padding: '2px 8px', borderRadius: '4px', fontSize: '0.85em', fontWeight: 500 }}>deprecated</mark>
