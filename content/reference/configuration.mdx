...
When `routes: "."` is used in conjuction with [`pear-electron`](https://github.com/holepunchto/pear-electron) and [`pear-bridge`](https://github.com/holepunchto/pear-bridge) [`waypoint`](https://github.com/holepunchto/pear-bridge/#options) option this enables in-app single-page-application routing.
