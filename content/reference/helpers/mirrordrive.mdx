...
[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L71)
...
[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L131)
...
[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L109)
...
[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L90)
...
[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L92)
- Returns: The total number of bytes copied into the destination so far.

#### `mirror.bytesRemoved`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L91)
- Returns: The total number of bytes removed from the destination so far.

#### `mirror.finished`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L94)
- Returns: `true` once the mirror pass has completed.

#### `mirror.preloaded`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L25)
- Returns: `true` once any configured preload phase has finished fetching the blob ranges or block maps it needs.

#### `mirror.peers`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L113)
- Returns: The source drive's current peer list when `src.core` exists, otherwise an empty array.

#### `mirror.downloadProgress`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L117)
- Returns: A `0..1` estimate of preload/download progress when progress tracking is enabled.

#### `mirror.downloadedBlocks`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L96)
- Returns: The number of blob blocks downloaded from the source during the current run.

#### `mirror.downloadedBytes`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L98)
- Returns: The number of blob bytes downloaded from the source during the current run.

#### `mirror.uploadedBlocks`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L101)
- Returns: The number of destination blob blocks uploaded or written during the current run.

#### `mirror.uploadedBytes`

[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L102)
...
[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L124)
...
[API definition on GitHub](https://github.com/holepunchto/mirror-drive/blob/v1.14.2/index.js#L187)
