...
```javascript file=<rootDir>/examples/how-to/connect-to-peers/connect-two-peers-by-key-with-hyperdht/server-app/index.js title="server-app/index.js" lineNumbers
```
...
```javascript file=<rootDir>/examples/how-to/connect-to-peers/connect-two-peers-by-key-with-hyperdht/client-app/index.js title="client-app/index.js" lineNumbers
```
