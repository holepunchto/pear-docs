...
The `writer-app` stores command-line input to a Hypercore instance and replicates that instance to other peers over [Hyperswarm](/referece/building-blocks/hyperswarm).
