...
In this guide we'll extend the ephemeral chat example in [Connect Many Peers](/how-to/connect-to-many-peers-by-topic-with-hyperswarm) but using Hypercore to add many significant new features:
