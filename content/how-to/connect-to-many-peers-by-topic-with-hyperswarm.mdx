...
In the [How to connect two Peers by key with Hyperdht](/how-to/connect-two-peers-by-key-with-hyperdht), we needed to explicitly indicate which peer was the server and which was the client. By using Hyperswarm, we create two peers, have them join a common topic, and let the swarm deal with connections.
