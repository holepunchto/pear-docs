...
- **For installing apps or binaries from a link**, the upcoming [`pear install`](/reference/cli#pear-install) command (preview: `npx pear-install pear://<key>`) pulls a build from the swarm without compiling a bootstrap binary yourself. See [Installing applications](/explanation/storage-and-distribution#installing-applications).
