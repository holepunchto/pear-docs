...
- [Set up multisig](/how-to/operate-an-app/multisig/set-up-multisig) — generate signing keys, write `multisig.json`, compute the multisig link, and point `upgrade` at it. Do this once.
...
- [`pear-ci` GitHub Action reference](/reference/pear-ci-action) — inputs, outputs, and the CLI behind CI publishing.
