...
#### `TimerError.code: string`

#### `TimerError.name: 'TimerError'`

#### `TimerError.INVALID_CALLBACK(msg?: string): TimerError`
...
#### `errors.TimerError.code: string`

#### `errors.TimerError.name: 'TimerError'`

#### `errors.TimerError.INVALID_CALLBACK(msg?: string): TimerError`
