...
| --- | --- | --- | --- |
| `stream` | `Duplex` | — | The duplex stream to frame RPC messages over, identifying each method by a unique command number — an IPC pipe, a TCP socket, or a [Bare Kit](/bare/reference/bare/bare-kit) worklet channel. |
...
- Pairs with [`hyperschema`](https://github.com/holepunchto/hyperschema) and [`compact-encoding`](/bare/reference/helpers/compact-encoding) to generate typed message codecs.
