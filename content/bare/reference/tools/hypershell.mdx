...
seoTitle: "Hypershell: Remote Shell & Tunneling over P2P"
docType: reference
product: bare
schemaType: APIReference
---

Hypershell is a set of CLI tools for encrypted shell access, file transfer, and local port forwarding over [HyperDHT](/bare/reference/building-blocks/hyperdht). This page documents the public binaries installed by [`hypershell`](https://github.com/holepunchto/hypershell).
...
[Command source on GitHub](https://github.com/holepunchto/hypershell/blob/v0.0.15/bin/keygen.js)

Create an Ed25519 seed file for Hypershell and other [HyperDHT](/bare/reference/building-blocks/hyperdht)-based tools.
...
[Command source on GitHub](https://github.com/holepunchto/hypershell/blob/v0.0.15/bin/server.js)
...
[Command source on GitHub](https://github.com/holepunchto/hypershell/blob/v0.0.15/bin/client.js)
...
[Command source on GitHub](https://github.com/holepunchto/hypershell/blob/v0.0.15/bin/copy.js)
...
- [Hyperssh—`hyperssh`](/bare/reference/tools/hyperssh#hyperssh)
- [Hypertele—expose a local TCP service](/bare/reference/tools/hypertele#expose-a-local-tcp-service-to-a-client-side-local-port)
- [Hyperbeam—one-to-one encrypted pipe](/bare/reference/tools/hyperbeam#hyperbeam)
- [Drives—`drives mirror`](/bare/reference/tools/drives#drives-mirror-src-dst)
