...
seoTitle: "Hyperbeam: Encrypted 1:1 Pipe over HyperDHT"
docType: reference
product: bare
...
[Command source on GitHub](https://github.com/holepunchto/hyperbeam/blob/v3.1.0/bin.js)
...
- [Hypertele—persistent TCP proxy](/bare/reference/tools/hypertele#expose-a-local-tcp-service-to-a-client-side-local-port)
