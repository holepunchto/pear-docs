...
seoTitle: "Drives: Mirror & Seed Hyperdrives from the CLI"
docType: reference
product: bare
...
Create a writable [Hyperdrive](/bare/reference/building-blocks/hyperdrive) and print its public key.
...
Mirror a local directory into a [Hyperdrive](/bare/reference/building-blocks/hyperdrive), mirror a Hyperdrive into a local directory, or mirror between two local targets.
...
Announce a [Hyperdrive](/bare/reference/building-blocks/hyperdrive) so other peers can download it.
...
- [Mirrordrive](/bare/reference/helpers/mirrordrive)—the sync engine powering `drives mirror`.
- [Hypershell—`hypershell-copy`](/bare/reference/tools/hypershell#hypershell-copy)
- [Hyperbeam—one-to-one pipe for ad-hoc transfers](/bare/reference/tools/hyperbeam#hyperbeam)
