...
Autobase is a higher-level composition over underlying [Hypercores](/bare/reference/building-blocks/hypercore). Writers append causal nodes to local cores, Autobase linearizes that graph into an eventually consistent order, and your `apply` handler materializes a deterministic view, often into a [Hyperbee](/bare/reference/building-blocks/hyperbee).
...
| --- | --- | --- | --- |
| `store` | [`Corestore`](/bare/reference/helpers/corestore) | — | The Corestore that holds the system, writer, and view cores. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `store` | [`Corestore`](/bare/reference/helpers/corestore) | The Corestore to open the core from. |
...
- Returns: [`Hypercore`](/bare/reference/building-blocks/hypercore) — The local writer core.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `core` | [`Hypercore`](/bare/reference/building-blocks/hypercore) | The bootstrap/local core to read from. |
...
- [Work with many Hypercores using Corestore](/bare/how-to/store-and-replicate/work-with-many-hypercores-using-corestore)—manage the groups of cores that Autobase coordinates.
- [Corestore](/bare/reference/helpers/corestore)—storage and replication manager typically used for Autobase system, writer, and view cores.
- [Hypercore](/bare/reference/building-blocks/hypercore)—append-only log primitive that Autobase writers build on.
- [Hyperbee](/bare/reference/building-blocks/hyperbee)—common materialized-view target for deterministic indexed state.
