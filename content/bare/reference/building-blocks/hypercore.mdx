...
upstreamVersion: "11.35.2"
seoTitle: "Hypercore: Secure Append-Only Log for P2P Apps"
docType: reference
product: bare
...
<Callout type="info">
For how Hypercore relates to Hyperblobs and [Hyperdrive](/bare/reference/building-blocks/hyperdrive), see [From append-only logs to files](/bare/explanation/from-logs-to-files).
</Callout>
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/lib/streams.js#L61)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L238)
...
- Returns: [`Hypercore`](/bare/reference/building-blocks/hypercore) — A new Hypercore session sharing the same underlying storage.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L570)

Attempt to apply blocks from the session to the `core`. `core` must be a default core, aka a non-named session.

| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `session` | [`Hypercore`](/bare/reference/building-blocks/hypercore) | — | The named or atom session whose staged blocks should be committed. |
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/lib/streams.js#L10)
...
- Returns: [`Hypercore`](/bare/reference/building-blocks/hypercore) — A new read-only Hypercore session locked to the current length.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1114)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1070)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L897)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1092)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L866)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L834)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L759)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L792)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1066)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1074)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1160)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1174)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1191)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1152)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1078)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1249)
...
This extension API is documented as legacy. For new protocol work, the upstream README recommends creating a [`Protomux`](/bare/reference/helpers/protomux) protocol instead.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L577)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L737)

Create a hook that tells Hypercore you are finding peers for this core in the background. Call `done` when your current discovery iteration is done. If you're using [Hyperswarm](/bare/reference/building-blocks/hyperswarm), you'd normally call this after a `swarm.flush()` finishes.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L753)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1020)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L997)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1011)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L1036)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L510)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L922)

Close every session on this core and permanently delete its storage from disk. Unlike `core.clear()`, which drops selected blocks, `purge()` removes the entire core.

- Returns: [`Promise<void>`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) — Resolves once the core's storage has been deleted.

#### `await core.ready()`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L691)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L279)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L273)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L299)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L303)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L294)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L700)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L707)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L629)

The core's manifest, optionally in its encoded wire form. Added in 11.35.0.

| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `options.raw` | `boolean` | `false` | Return the manifest encoded as a Buffer instead of as an object. |

- Returns: `object \| Buffer \| null` — the manifest, or `null` before the core is opened.

### Properties

#### `core.writable`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L78)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L77)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L613)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L617)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L76)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L621)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L634)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L646)

The cumulative size, in bytes, of all blocks in the core.

- Returns: `number` — Total byte length of the core (0 before the core is opened).

#### `core.manifest`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L625)

The core's manifest—the signed description of its cryptographic configuration (version, signers, prologue, and so on).

- Returns: `object \| null` — The manifest object, or `null` before the core is opened.

See [`core.getManifest()`](#coregetmanifestoptions) for the encoded form.

#### `core.signedLength`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L639)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L657)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L652)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L666)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L671)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L679)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L349)

Emitted when the core has been fully closed.

#### `core.on('ready')`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L362)
...
Emitted when the core migrates to a new key—for example after a manifest change. The listener receives the new `core.key`.

### Static helpers

#### `Hypercore.MAX_SUGGESTED_BLOCK_SIZE`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L118)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L133)

`options` include:

| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `manifest` | [`Buffer\|object`](https://nodejs.org/api/buffer.html#class-buffer) | — | A 32-byte public key Buffer, an encoded manifest Buffer, or a full manifest object with a `signers` array. |
| `options` | [`KeyOptions`](#keyoptions) | `{}` | — |

- Returns: [`Buffer`](https://nodejs.org/api/buffer.html#class-buffer) — the key for a given manifest.

A Buffer is read as a public key only when it is exactly 32 bytes; any other length is parsed as an encoded manifest. Added in 11.35.0—on earlier releases every Buffer is treated as a public key.

#### `Hypercore.parseManifest(manifest, [key])`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L143)

Decode and validate a manifest. Added in 11.35.0.

| Parameter | Type | Description |
| --- | --- | --- |
| `manifest` | [`Buffer\|object`](https://nodejs.org/api/buffer.html#class-buffer) | An encoded manifest Buffer, or a manifest object. |
| `key` | [`Buffer`](https://nodejs.org/api/buffer.html#class-buffer) | Optional. When given, the parsed manifest must hash to this key. |

- Returns: `object \| null` — the parsed manifest, or `null` when it cannot be created.
- Throws `BAD_ARGUMENT` if `quorum` exceeds the number of `signers`, and `INVALID_CHECKSUM` if `key` is supplied and the manifest does not hash to it.

#### `Hypercore.discoveryKey(key)`

[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L158)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L162)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L166)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L170)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L174)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.35.2/index.js#L208)
...
Options for Hypercore.defaultStorage(). If the first argument is already a storage instance it is returned as-is; otherwise it is treated as a directory and the options are forwarded verbatim to the [`hypercore-storage`](https://github.com/holepunchto/hypercore-storage) constructor. Hypercore itself reads none of them.
...
- [Replicate and persist with Hypercore](/bare/how-to/store-and-replicate/replicate-and-persist-with-hypercore)—pair a single core with peer discovery and replication.
- [Work with many Hypercores using Corestore](/bare/how-to/store-and-replicate/work-with-many-hypercores-using-corestore)—recommended pattern when one process manages multiple cores.
- [Corestore](/bare/reference/helpers/corestore)—helper reference for creating, naming, and co-replicating groups of Hypercores.
- [Hyperbee](/bare/reference/building-blocks/hyperbee)—sorted key/value B-tree built directly on top of a Hypercore.
- [Hyperdrive](/bare/reference/building-blocks/hyperdrive)—filesystem abstraction whose metadata and blob stores are Hypercore-backed.
- [Compact encoding](/bare/reference/helpers/compact-encoding)—binary encoding toolkit used to structure Hypercore block payloads.
