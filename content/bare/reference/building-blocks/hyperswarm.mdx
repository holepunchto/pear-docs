...
upstreamVersion: "4.17.0"
seoTitle: "Hyperswarm: Topic-Based P2P Peer Discovery"
docType: reference
product: bare
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.0/lib/peer-discovery.js#L310)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.0/lib/peer-discovery.js#L333)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.0/lib/peer-info.js#L33)
...
- [Connect to many peers by topic with Hyperswarm](/bare/how-to/connect-to-peers/connect-to-many-peers-by-topic-with-hyperswarm)—broader topic-based discovery walkthrough.
- [Connect two peers by key with HyperDHT](/bare/how-to/connect-to-peers/connect-two-peers-by-key-with-hyperdht)—direct one-to-one connections without topic discovery.
- [HyperDHT](/bare/reference/building-blocks/hyperdht)—lower-level DHT and hole-punching layer beneath Hyperswarm.
- [Secretstream](/bare/reference/helpers/secretstream)—the encrypted stream type that Hyperswarm connections expose.
- [Protomux](/bare/reference/helpers/protomux)—multiplex multiple protocols across one Hyperswarm connection.
- [Corestore](/bare/reference/helpers/corestore)—pass swarm connections directly to `store.replicate()` to co-replicate all managed cores.
