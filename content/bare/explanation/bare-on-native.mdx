...
* The **core** runs as a Bare *worklet*—an isolated Bare thread—and owns everything peer-to-peer:
   ...
   * opens the [Corestore](/bare/reference/helpers/corestore)
   * runs [Hyperswarm](/bare/reference/building-blocks/hyperswarm) and [HyperDHT](/bare/reference/building-blocks/hyperdht)
...
* [`hyperschema`](https://github.com/holepunchto/hyperschema) defines versioned, append-only data structures and generates [`compact-encoding`](/bare/reference/helpers/compact-encoding) codecs for them.
