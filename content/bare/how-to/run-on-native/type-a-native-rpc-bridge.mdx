...
The pieces: [`hyperschema`](https://github.com/holepunchto/hyperschema) defines the data structures and generates [`compact-encoding`](/bare/reference/helpers/compact-encoding) codecs; [`bare-rpc`](/bare/reference/modules/bare-modules) frames requests and replies over the IPC stream.
...
- [Compact encoding](/bare/reference/helpers/compact-encoding)—the codec `hyperschema` generates.
