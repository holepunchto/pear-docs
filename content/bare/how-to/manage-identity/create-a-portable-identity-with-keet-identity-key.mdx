...
Attach `proof` to whatever you append to your [Hypercore](/bare/reference/building-blocks/hypercore)/Autobase alongside the payload.
...
- [Add Keet identity to a chat app](/bare/how-to/manage-identity/add-keet-identity-to-a-chat-app)—this primitive wired into a full desktop chat, stamping every message with a verifiable identity.
- [Connect two peers by key with HyperDHT](/bare/how-to/connect-to-peers/connect-two-peers-by-key-with-hyperdht)—once you have a stable identity key, you can dial it directly.
- [Secretstream](/bare/reference/helpers/secretstream)—the noise-based encrypted transport that authenticates connections by public key.
