...
- Comfort with [Corestore](/bare/reference/helpers/corestore) and the [Autobase](/bare/reference/building-blocks/autobase)-backed room model.
...
- `…/app-storage/corestore/`—the [Hypercore](/bare/reference/building-blocks/hypercore) data
...
Quit the app, blow away the [Corestore](/bare/reference/helpers/corestore) but **keep `identity-mnemonic.txt`** (substitute your own `productName` for `<productName>`):
