...
- [From append-only logs to files](/bare/explanation/from-logs-to-files)—why a [Hyperdrive](/p2p/reference/building-blocks/hyperdrive) ends up looking like a filesystem.
