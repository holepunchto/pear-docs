...
- [Stream a live camera in a peer-to-peer app](/bare/how-to/stream-and-share-media/stream-a-live-camera-in-a-peer-to-peer-app)—the sibling how-to that establishes the same Hyperblobs + blob-server pattern for live frames.
...
- [Stream a live camera in a peer-to-peer app](/bare/how-to/stream-and-share-media/stream-a-live-camera-in-a-peer-to-peer-app)—the same Hyperblobs + blob-server pattern for live frames.
- [Stream stored video in a peer-to-peer app](/bare/how-to/stream-and-share-media/stream-stored-video-in-a-peer-to-peer-app)—the same blob mechanics for stored video.
