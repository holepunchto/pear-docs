...
<Cards>
  ...
  />
  <Card
    href="/getting-started/build-a-peer-to-peer-chat/production-shape"
...
- The [`pear`](/reference/cli) CLI (`npx pear`) — only required for parts 3 and 4 (shipping and updating)
