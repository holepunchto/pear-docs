...
<Callout type="info">
The hint blocks at the end of both stage outputs arrive with Pear 3.3.0. On 3.2.0 and earlier the output stops at the versioned link. See [Next-step hints](/reference/pear/cli#next-step-hints).
</Callout>
...
<Callout type="info">
On Pear 3.2.0 and earlier the same link is printed inside the `Provisioned:` block under a `Seed with:` heading instead of in a hint block. See [Next-step hints](/reference/pear/cli#next-step-hints).
</Callout>
