...
- **Lines 24–27:** the worker opens its **own** `FramedStream` pipe, [Corestore](/reference/helpers/corestore), and [Hyperswarm](/reference/building-blocks/hyperswarm), then constructs the [`pear-runtime`](/reference/pear/runtime) updater over them—independent of the chat worker's swarm and store.
