...
2. Layer [HRPC](/reference/helpers/hrpc) on the same channel for typed, schema-generated request/response methods instead of hand-checking a `type` field—recommended once you have more than a message or two. See [Structured RPC over IPC](/explanation/workers#structured-rpc-over-ipc).
