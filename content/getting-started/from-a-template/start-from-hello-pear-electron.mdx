...
<Callout type="info">
For the peer-to-peer fundamentals behind this template—how peers discover each other and talk without servers—read [Peer-to-peer, demystified](/explanation/peer-to-peer-demystified) and [The Pear stack](/explanation/the-pear-stack).
</Callout>
