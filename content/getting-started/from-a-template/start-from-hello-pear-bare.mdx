...
<Callout type="info">
New to peer-to-peer? [Peer-to-peer, demystified](/explanation/peer-to-peer-demystified) explains how peers find each other and connect directly over the DHT, and [The Pear stack](/explanation/the-pear-stack) maps how Bare, `pear-runtime`, Hyperswarm, and Corestore fit together.
</Callout>
...
| [`workers/main.js`](https://github.com/holepunchto/hello-pear-bare/blob/main/workers/main.js) | The Bare [worker](/explanation/workers) that owns the peer-to-peer code and the `pear-runtime` updater. | Yes—this is your backend. |
