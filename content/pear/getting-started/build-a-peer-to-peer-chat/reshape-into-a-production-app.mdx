...
- [Share files in a peer-to-peer app](/bare/how-to/stream-and-share-media/share-files-in-a-peer-to-peer-app)—swap the room's HyperDB view for a [Hyperdrive](/p2p/reference/building-blocks/hyperdrive).
