...
- [Stream stored video in a peer-to-peer app](/pear/how-to/stream-and-share-media/stream-stored-video-in-a-peer-to-peer-app)—same scaffold, range-served blobs instead of files.
