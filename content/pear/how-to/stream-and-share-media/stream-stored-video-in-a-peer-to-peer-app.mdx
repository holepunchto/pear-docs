...
- [Stream a live camera in a peer-to-peer app](/pear/how-to/stream-and-share-media/stream-a-live-camera-in-a-peer-to-peer-app)—the live counterpart that builds on the same blob plumbing.
...
- [Stream a live camera in a peer-to-peer app](/pear/how-to/stream-and-share-media/stream-a-live-camera-in-a-peer-to-peer-app)—same blob mechanics for live frames.
- [Back up photos in a peer-to-peer app](/pear/how-to/stream-and-share-media/back-up-photos-in-a-peer-to-peer-app)—same scaffold with `bare-ffmpeg`/`bare-media` for media decoding.
