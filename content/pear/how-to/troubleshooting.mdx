...
- Random NAT networks can take longer as another node may be needed to facilitate the connection. See [Dependencies and network](/pear/explanation/dependencies-and-network) for what's actually happening at the IP level.
