...
The two-event split is what lets you build UI like the "Update ready" banner in [Reshape into a production app](/pear/getting-started/build-a-peer-to-peer-chat/reshape-into-a-production-app): show a spinner on `updating`, swap to a restart button on `updated`, restart the app on click.
