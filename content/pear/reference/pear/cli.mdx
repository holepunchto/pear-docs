...
<Callout type="info">
This page tracks **Pear 3.4.0**. Several commands were removed in v3—most notably `pear run`, which is replaced by embedding the **[Pear OTA](/pear/reference/pear/runtime)** (`pear-runtime`) library. Removed commands are kept below with a badge and migration guidance.
...
For the full release walkthrough, see [Deploy a Pear desktop app](/pear/how-to/operate-an-app/manual-deployment/deployment) and [Build desktop distributables](/pear/how-to/operate-an-app/build-and-package/build-desktop-distributables); for the mobile flags (`--ios-*`, `--android-arm64`), see [Deploy your mobile application](/pear/how-to/operate-an-app/manual-deployment/mobile).
