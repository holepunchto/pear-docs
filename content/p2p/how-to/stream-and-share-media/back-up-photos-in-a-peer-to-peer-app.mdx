...
```js file=<rootDir>/examples/how-to/stream-and-share-media/photo-backup/workers/video-room.js#L181-L203 title="workers/video-room.js" lineNumbers {1,3-6,8-14,15,17,20-22} skip="example-import"
```
