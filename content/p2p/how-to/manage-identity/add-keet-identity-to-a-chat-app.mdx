...
```js file=<rootDir>/examples/how-to/manage-identity/keet-identity/workers/index.js#L27-L35 title="workers/index.js" lineNumbers {1,2,4,7,9} skip="example-import"
```
...
```js file=<rootDir>/examples/how-to/manage-identity/keet-identity/renderer/app.js#L43-L54 title="renderer/app.js" lineNumbers {1-5,11} skip="example-import"
```
...
- [Create a portable identity with Keet identity keys](/p2p/how-to/manage-identity/create-a-portable-identity-with-keet-identity-key)—the Pear/Bare identity primitive behind this app, with no UI.
- [Connect two peers by key with HyperDHT](/p2p/how-to/connect-to-peers/connect-two-peers-by-key-with-hyperdht)—once you have an identity key, you can dial it directly.
- [Add blind peering to a chat app](/p2p/how-to/blind-peering/add-blind-peering-to-a-chat-app)—keep the room reachable while the identity-holding device is offline.
