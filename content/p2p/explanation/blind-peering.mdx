...
<Callout type="info">
If that peer is a Pear machine rather than a standalone swarm node, it reads its own identity with `pear identity blind-peer-client`—see [Look up this machine's network keys](/pear/how-to/look-up-network-keys).
</Callout>
