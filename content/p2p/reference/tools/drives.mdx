...
Create a writable [Hyperdrive](/p2p/reference/building-blocks/hyperdrive) and print its public key.
...
Mirror a local directory into a [Hyperdrive](/p2p/reference/building-blocks/hyperdrive), mirror a Hyperdrive into a local directory, or mirror between two local targets.
...
Announce a [Hyperdrive](/p2p/reference/building-blocks/hyperdrive) so other peers can download it.
...
- [Hyperdrive](/p2p/reference/building-blocks/hyperdrive)
- [Localdrive](/p2p/reference/helpers/localdrive)
- [Mirrordrive](/p2p/reference/helpers/mirrordrive)—the sync engine powering `drives mirror`.
- [Hypershell—`hypershell-copy`](/p2p/reference/tools/hypershell#hypershell-copy)
- [Hyperbeam—one-to-one pipe for ad-hoc transfers](/p2p/reference/tools/hyperbeam#hyperbeam)
