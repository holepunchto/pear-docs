...
Hypershell is a set of CLI tools for encrypted shell access, file transfer, and local port forwarding over [HyperDHT](/p2p/reference/building-blocks/hyperdht). This page documents the public binaries installed by [`hypershell`](https://github.com/holepunchto/hypershell).
...
Create an Ed25519 seed file for Hypershell and other [HyperDHT](/p2p/reference/building-blocks/hyperdht)-based tools.
...
- [Hyperssh—`hyperssh`](/p2p/reference/tools/hyperssh#hyperssh)
- [Hypertele—expose a local TCP service](/p2p/reference/tools/hypertele#expose-a-local-tcp-service-to-a-client-side-local-port)
- [Hyperbeam—one-to-one encrypted pipe](/p2p/reference/tools/hyperbeam#hyperbeam)
- [Drives—`drives mirror`](/p2p/reference/tools/drives#drives-mirror-src-dst)
