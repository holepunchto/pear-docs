...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L971)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L531)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L551)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L571)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L924)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L953)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L185)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L229)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L296)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L326)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L298)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L383)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L395)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L464)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L549)

Prebuilt fixed-size buffer encoders — `cenc.fixed8`, `cenc.fixed16`, `cenc.fixed24`, `cenc.fixed32`, and `cenc.fixed64` — for 8, 16, 24, 32, and 64-byte values.
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L516)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L518)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L381)

A length-prefixed encoder for an array of booleans, packed one bit per value.

- Returns: `object`

```js
const cenc = require('compact-encoding')
const buf = cenc.encode(cenc.bitarray, [true, false, true])
const val = cenc.decode(cenc.bitarray, buf) // [true, false, true]
```

#### `cenc.date`

[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L598)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L622)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L635)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L713)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L731)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L885)
...
[src](https://github.com/holepunchto/compact-encoding/blob/v3.5.0/index.js#L905)
...
| `cenc.fixed8` | Fixed 8-byte buffer. |
| `cenc.fixed16` | Fixed 16-byte buffer. |
| `cenc.fixed24` | Fixed 24-byte buffer. |
...
| `cenc.bitarray` | Length-prefixed array of booleans, packed one bit per value. |
