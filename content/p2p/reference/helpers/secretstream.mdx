...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L123)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L155)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L93)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L105)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L118)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L564)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L572)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L600)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L603)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L610)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L89)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L27)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L28)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L29)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L31)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L43)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L44)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L517)
...
[src](https://github.com/holepunchto/hyperswarm-secret-stream/blob/v6.9.2/index.js#L390)
...
| `filterZeroByteMessages` | `boolean` | `false` | Drop zero-byte messages before they reach the message handler. Also on whenever `keepAlive` is set, so existing keep-alive users keep filtering by default; set this explicitly to filter without enabling keep-alive. |
