...
`Corestore` manages many related [Hypercores](/p2p/reference/building-blocks/hypercore) behind one storage root and one replication surface. It is the helper you usually share across [Hyperbee](/p2p/reference/building-blocks/hyperbee), [Hyperdrive](/p2p/reference/building-blocks/hyperdrive), and [Autobase](/p2p/reference/building-blocks/autobase) instances. For upstream source and changelog context, see the [Corestore repository](https://github.com/holepunchto/corestore).
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L207)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L353)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L360)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L242)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L257)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L255)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L259)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L261)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L561)
...
- Returns: [`Hypercore`](/p2p/reference/building-blocks/hypercore) — A Hypercore session for the requested core.

`allowLatestBlock` is forwarded through to the returned Hypercore's own [`allowLatestBlock` option](/p2p/reference/building-blocks/hypercore#hypercoreoptions).
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L364)
...
- Returns: [`Corestore`](/p2p/reference/helpers/corestore) — A new Corestore session sharing the same storage.
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L374)
...
- Returns: [`Corestore`](/p2p/reference/helpers/corestore) — A new namespaced Corestore session.
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L478)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L338)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L381)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L385)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L618)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L349)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L517)

A reopened Hypercore whose manifest is converted into a static prologue-based manifest for the current data snapshot.

| Parameter | Type | Description |
| --- | --- | --- |
| `core` | [`Hypercore`](/p2p/reference/building-blocks/hypercore) | The source core to snapshot. Must have data. |
| `opts` | `object` | Options forwarded to `store.get()` for the new core. |

- Returns: [`Promise<Hypercore>`](/p2p/reference/building-blocks/hypercore) — The new static Hypercore.
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L280)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L289)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L309)
...
- Returns: [`GroupNotifyHandle`](/p2p/reference/helpers/corestore) — A handle that emits `update` when a core in the group changes.
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L231)
...
[src](https://github.com/holepunchto/corestore/blob/v7.12.5/index.js#L301)
...
| `treeCache` | `object` | — | Forwarded to the underlying storage layer (`Hypercore.defaultStorage`) for its Merkle tree cache. Not documented upstream beyond the README's mention of a `{ maxSize: 8192 }`-shaped default; verified only that this option is read and forwarded, not the storage layer's own default. |
