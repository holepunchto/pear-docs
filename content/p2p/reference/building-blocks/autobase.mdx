...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1010)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L894)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L934)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1983)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1987)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1136)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1093)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1106)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1115)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/lib/apply-calls.js#L91)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L2060)

Triggered when the autobase view updates after `apply` has finished running.

#### `base.on('interrupt', (reason) => { ... })`

[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L838)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1502)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1712)

Triggered when the autobase instance is an indexer.

#### `base.on('is-non-indexer', () => { ... })`

[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L1723)
...
[src](https://github.com/holepunchto/autobase/blob/v7.28.2/index.js#L852)
