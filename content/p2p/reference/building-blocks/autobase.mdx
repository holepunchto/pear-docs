...
| --- | --- | --- | --- |
| `store` | [`Corestore`](/p2p/reference/helpers/corestore) | — | The Corestore that holds the system, writer, and view cores. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| `store` | [`Corestore`](/p2p/reference/helpers/corestore) | The Corestore to open the core from. |
...
- Returns: [`Hypercore`](/p2p/reference/building-blocks/hypercore) — The local writer core.
...
| Parameter | Type | Description |
| --- | --- | --- |
| `core` | [`Hypercore`](/p2p/reference/building-blocks/hypercore) | The bootstrap/local core to read from. |
...
- [Build a multiwriter app with Autobase](/p2p/how-to/store-and-replicate/build-a-multiwriter-app-with-autobase)—two-peer walkthrough covering `open`, `apply`, and granting write access.
...
- [Autobee](/p2p/reference/building-blocks/autobee)—the same linearization with the view fixed to a Hyperbee and the B-tree write path built in.
