...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L23)
...
- Parameters:
  ...
  - `opts.relayThrough`: Public key of a node to relay connections through, or a function `(force, swarm) => publicKey | null` that picks one. A plain key is used only when `force` is set or the swarm's DHT node is randomized. `force` becomes `true` for a peer after a client connection fails with `HOLEPUNCH_ABORTED`, `HOLEPUNCH_DOUBLE_RANDOMIZED_NATS`, `REMOTE_NOT_HOLEPUNCHABLE`, or—from v4.17.1—`CANNOT_HOLEPUNCH`, and its retry backoff resets so the relayed attempt runs promptly.
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L64)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L65)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L66)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L38)
- Signature: `swarm.dht`
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L501)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L525)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L487)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L567)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L543)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L556)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L244)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L104)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L484)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L491)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L606)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L642)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/index.js#L588)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/lib/peer-discovery.js#L191)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/lib/peer-discovery.js#L310)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/lib/peer-discovery.js#L333)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/lib/peer-info.js#L17)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/lib/peer-info.js#L33)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/lib/peer-info.js#L52)
...
[API definition on GitHub](https://github.com/holepunchto/hyperswarm/blob/v4.17.1/lib/peer-info.js#L109)
...
- [ble-swarm](https://github.com/holepunchto/ble-swarm)—Bluetooth LE transport for Hyperswarm, for peers with no shared internet path. Not yet documented on this site.
