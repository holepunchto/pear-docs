...
<Callout type="info">
For how Hypercore relates to Hyperblobs and [Hyperdrive](/p2p/reference/building-blocks/hyperdrive), see [From append-only logs to files](/p2p/explanation/from-logs-to-files).
</Callout>
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/lib/streams.js#L61)
...
| `group` | — | Advanced option. A 32-byte group topic to assign the core to, which Corestore's [`store.notifyGroup(topic)`](/p2p/reference/helpers/corestore#storenotifygrouptopic) watches. Only applied if the core has no group yet; from v11.35.4 that includes a new session on an already-open core. See [`core.setGroup(topic)`](#await-coresetgrouptopic) |
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L238)
...
- Returns: [`Hypercore`](/p2p/reference/building-blocks/hypercore) — A new Hypercore session sharing the same underlying storage.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L570)

Attempt to apply blocks from the session to the `core`. `core` must be a default core, aka a non-named session.

| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `session` | [`Hypercore`](/p2p/reference/building-blocks/hypercore) | — | The named or atom session whose staged blocks should be committed. |
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/lib/streams.js#L10)
...
- Returns: [`Hypercore`](/p2p/reference/building-blocks/hypercore) — A new read-only Hypercore session locked to the current length.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1114)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1070)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L897)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1092)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L866)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L834)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L759)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L792)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1066)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1074)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1160)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1174)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1191)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1152)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1078)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1249)
...
This extension API is documented as legacy. For new protocol work, the upstream README recommends creating a [`Protomux`](/p2p/reference/helpers/protomux) protocol instead.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L577)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L737)

Create a hook that tells Hypercore you are finding peers for this core in the background. Call `done` when your current discovery iteration is done. If you're using [Hyperswarm](/p2p/reference/building-blocks/hyperswarm), you'd normally call this after a `swarm.flush()` finishes.
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L311)
...
| Parameter | Type | Description |
| --- | --- | --- |
| `enabled` | `boolean` | Whether to always request the latest block on an upgrade. |

### Storage inspection and mark-and-sweep

#### `await core.info([options])`

[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L753)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1020)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L997)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1011)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L1036)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L510)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L922)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L691)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L279)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L273)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L299)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L303)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L294)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L700)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L707)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L629)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L78)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L77)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L613)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L617)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L76)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L621)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L634)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L646)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L625)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L639)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L657)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L652)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L666)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L671)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L679)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L349)

Emitted when the core has been fully closed.

#### `core.on('ready')`

[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L362)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L118)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L133)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L143)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L158)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L162)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L166)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L170)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L174)
...
[src](https://github.com/holepunchto/hypercore/blob/v11.36.1/index.js#L208)
