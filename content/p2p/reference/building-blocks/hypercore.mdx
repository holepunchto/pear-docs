...
<Callout type="info">
For how Hypercore relates to Hyperblobs and [Hyperdrive](/p2p/reference/building-blocks/hyperdrive), see [From append-only logs to files](/bare/explanation/from-logs-to-files).
</Callout>
