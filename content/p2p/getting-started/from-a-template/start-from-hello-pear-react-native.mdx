...
| [`workers/main.js`](https://github.com/holepunchto/hello-pear-react-native/blob/main/workers/main.js) | The app logic—a [Bare](/bare/reference/bare/modules) worker that owns the swarm, storage, and updater. | Yes—this is your backend. |
