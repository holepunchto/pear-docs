...
This page explains **why** a production-style Pear **Electron** app usually separates three concerns: **over-the-air (OTA) updates**, **persistent peer-to-peer storage**, and **Bare workers** behind a single IPC stream. Read it if you are sketching your own main/renderer/worker split or comparing a full runtime setup to the minimal [getting started chat](/getting-started/chat).

<Callout type="info">

**Hands-on in this repo:** [Getting started — ship and update](/getting-started/ship-and-update), [Deploy your application](/how-to/operate-an-app/deployment), and [Build desktop distributables](/how-to/operate-an-app/build-desktop-distributables) walk the same production-shaped Electron + `pear-runtime` path. The prose here stays **template-agnostic**.
