...
For more information about the `pear data apps` command, see the [cli docs](/reference/cli.md#pear-data-apps-flags-link).
...
For more information about the `pear reset` command, see the [cli docs](/reference/cli.md#pear-reset-flags-less-than-link-greater-than).
...
This path can be accessed in a Pear application via [`Pear.config.pearDir`](/reference/api.md#pear.config.peardir-less-than-string-greater-than).
